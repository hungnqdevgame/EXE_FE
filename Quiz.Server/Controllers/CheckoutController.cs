...
namespace Quiz.Server.Controllers
{
    ...
    public class CheckoutController : ControllerBase
    {
        ...
        [HttpGet("/success")]
        public async Task<IActionResult> Success([FromQuery] long orderCode, [FromServices] QuizDBContext context)
        {
            try
            {
        ...
        public async Task<IActionResult> Checkout(CheckoutDTO dto, [FromServices] QuizDBContext context)
        {
            try
            {
                ...
                var payment = new DAL.Model.Payment
                {
                    UserId = dto.UserId,
                ...
                Console.WriteLine($"💾 Đã lưu Payment Order {orderCode} cho User {dto.UserId}");
